...
#   pyspark --packages io.github.juarezr:spark-streaming-google-pubsub_2.12:0.6.3
# Spark 4.x (Scala 2.13):
#   pyspark --packages io.github.juarezr:spark-streaming-google-pubsub_2.13:0.6.3
# or:
